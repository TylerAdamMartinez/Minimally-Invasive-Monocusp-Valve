...
int main()
{
	float CS, vR, height, thinkness, DR, Diskheight;
	cout << "The cross-sectional area of the valve: ";
	cin >> CS;
	...
	float TotalCost, ORcost, IRcost, Dcost;
	ORcost = ORV * TF + NS;
	IRcost = IRV * PPC;
	...
	cout << "The total cost of your heart valve is $ " << TotalCost << endl;

		// Hemodynamic Calculations
		int SV, HR, CO;
		cout << "Enter in the Stroke Volume of the patient: ";
		cin >> SV;
		cout << "Enter in the Heart Rate of the patient: ";
		cin >> HR;
		CO = SV * HR;
		cout << "The Cardiac Output of the patient is " << CO << endl;

		int SBP, DBP;
		float MAP;
		cout << "Enter in the Systomic Blood Pressure of the patient: ";
		cin >> SBP;
		cout << "Enter in the Diastolic Blood Pressure of the patient: ";
		cin >> DBP;
		MAP = (((SBP) + (2 *(DBP)))/ 3);
		cout << "The Mean Arterial Pressure of the patient is " << MAP << endl;

		int CVP;
		float SVR;
		cout << "Enter in the Central Venous Pressure of the patient: ";
		cin >> CVP;
		SVR =  ((MAP - CVP)/(CO)) * 80;
		cout << "The Systemic Vascular Resistance of the patient is " << SVR << endl;
